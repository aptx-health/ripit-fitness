...
export default function SetList({
  ...
  return (
    <>
      ...
      <div>
        <h4 className="text-base sm:text-lg font-semibold text-foreground mb-2">Target</h4>
      ...
      {loggedSets.length > 0 && (
        <div className="mt-4">
          <h4 className="text-base sm:text-lg font-semibold text-foreground mb-2">Logged Sets</h4>
          <div className="space-y-2">
            {loggedSets.map((set) => (
              <div
                key={`${set.exerciseId}-${set.setNumber}`}
                className="bg-success-muted border border-success-border rounded-xl p-3 sm:p-4 flex items-center justify-between"
              >
                ...
                <button
                  ...
                  className="text-error hover:text-error-hover p-1 ml-2"
                >
