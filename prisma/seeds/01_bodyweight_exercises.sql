...
4. After a brief pause at the top contracted position, you can begin to lower yourself downward again for as many repetitions as needed.', NOW(), NOW()),
...
3. Now breathe out and press your upper body back up to the starting position while squeezing your chest.
4. After a brief pause at the top contracted position, you can begin to lower yourself downward again for as many repetitions as needed.', NOW(), NOW()),
('ex_bw_003', 'Diamond Push-Up', 'diamond push-up', ARRAY['diamond pushup', 'close grip pushup', 'triangle pushup'], 'chest', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['bodyweight'], ARRAY['triceps', 'chest'], ARRAY['front-delts'], null, NOW(), NOW()),
...
3. Push body up until arms are extended. Repeat.', NOW(), NOW()),
('ex_bw_006', 'Pike Push-Up', 'pike push-up', ARRAY['pike pushup', 'shoulder pushup'], 'shoulders', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['bodyweight'], ARRAY['front-delts', 'triceps'], ARRAY['chest'], null, NOW(), NOW()),
('ex_bw_007', 'Archer Push-Up', 'archer push-up', ARRAY['archer pushup', 'side to side pushup'], 'chest', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['bodyweight'], ARRAY['chest', 'triceps'], ARRAY['front-delts'], null, NOW(), NOW()),

-- Pull-up/Chin-up variations
('ex_bw_008', 'Chin-Up', 'chin-up', ARRAY['chinup', 'chin up', 'underhand pullup'], 'back', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['pull-up bar'], ARRAY['biceps', 'lats'], ARRAY['mid-back', 'forearms'], '1. Grab the pull-up bar with the palms facing your torso and a grip closer than the shoulder width.
...
('ex_bw_009', 'Wide Grip Pull-Up', 'wide grip pull-up', ARRAY['wide pullup', 'wide grip pullup'], 'back', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['pull-up bar'], ARRAY['lats'], ARRAY['mid-back', 'biceps'], '1. Grab the pull-up bar with the palms facing forward using a wide grip.
...
5. Repeat this motion for the prescribed amount of repetitions.', NOW(), NOW()),
('ex_bw_010', 'Neutral Grip Pull-Up', 'neutral grip pull-up', ARRAY['neutral pullup', 'parallel grip pullup', 'hammer grip pullup'], 'back', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['pull-up bar'], ARRAY['lats', 'biceps'], ARRAY['forearms'], null, NOW(), NOW()),
('ex_bw_011', 'L-Sit Pull-Up', 'l-sit pull-up', ARRAY['l sit pullup', 'lsit pullup'], 'back', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['pull-up bar'], ARRAY['lats', 'biceps', 'abs'], ARRAY['forearms'], null, NOW(), NOW()),
('ex_bw_012', 'Muscle-Up', 'muscle-up', ARRAY['muscle up', 'muscleup'], 'back', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['pull-up bar'], ARRAY['lats', 'triceps', 'chest'], ARRAY['front-delts'], '1. Grip the rings using a false grip, with the base of your palms on top of the rings. Initiate a pull up by pulling the elbows down to your side, flexing the elbows.
...
4. Use care when lowering yourself to the ground.', NOW(), NOW()),
...
3. Continue down to full depth if you are able,and quickly reverse the motion until you return to the starting position. As you squat, keep your head and chest up and push your knees out.', NOW(), NOW()),
...
5. Absorb the impact by reverting back to the starting position.', NOW(), NOW()),
...
7. Switch legs and repeat the movement.', NOW(), NOW()),
...
4. At the bottom of the movement, reverse the motion, extending through the hip and knee to return to the starting position.', NOW(), NOW()),
...
2. Begin the movement by flexing your knees and hips, sitting back with your hips.
3. Continue until you have squatted a portion of the way down, but are above parallel, and quickly reverse the motion until you return to the starting position. Repeat for 5-10 repetitions.', NOW(), NOW()),
...
('ex_bw_019', 'Reverse Lunge', 'reverse lunge', ARRAY['backward lunge', 'step back lunge'], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['bodyweight'], ARRAY['quads', 'glutes'], ARRAY['hamstrings'], null, NOW(), NOW()),
...
('ex_bw_027', 'Hanging Leg Raise', 'hanging leg raise', ARRAY['hanging leg raises', 'hanging knee raise'], 'core', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['pull-up bar'], ARRAY['abs'], ARRAY['forearms', 'lats'], '1. Hang from a chin-up bar with both arms extended at arms length in top of you using either a wide grip or a medium grip. The legs should be straight down with the pelvis rolled slightly backwards. This will be your starting position.
2. Raise your legs until the torso makes a 90-degree angle with the legs. Exhale as you perform this movement and hold the contraction for a second or so.
3. Go back slowly to the starting position as you breathe in.
4. Repeat for the recommended amount of repetitions.', NOW(), NOW()),
...
2. Explosively reverse the positions of your legs, extending the bent leg until the leg is straight and supported by the toe, and bringing the other foot up with the hip and knee flexed. Repeat in an alternating fashion for 20-30 seconds.', NOW(), NOW()),
('ex_bw_029', 'Hollow Body Hold', 'hollow body hold', ARRAY['hollow hold', 'hollow body'], 'core', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['bodyweight'], ARRAY['abs'], ARRAY[]::text[], null, NOW(), NOW()),
('ex_bw_030', 'V-Up', 'v-up', ARRAY['v up', 'vup', 'jackknife'], 'core', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['bodyweight'], ARRAY['abs'], ARRAY[]::text[], null, NOW(), NOW()),

-- Plank variations
('ex_bw_031', 'Side Plank', 'side plank', ARRAY['side planks'], 'core', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['bodyweight'], ARRAY['obliques'], ARRAY['front-delts'], null, NOW(), NOW()),
('ex_bw_032', 'Plank to Push-Up', 'plank to push-up', ARRAY['up down plank', 'plank up down'], 'core', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['bodyweight'], ARRAY['abs', 'triceps'], ARRAY['front-delts', 'chest'], null, NOW(), NOW()),
('ex_bw_033', 'Plank Shoulder Tap', 'plank shoulder tap', ARRAY['shoulder taps', 'plank taps'], 'core', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['bodyweight'], ARRAY['abs'], ARRAY['obliques'], null, NOW(), NOW()),

-- Dip variations
('ex_bw_034', 'Tricep Dip', 'tricep dip', ARRAY['triceps dip', 'bench dip'], 'arms', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dip bars'], ARRAY['triceps'], ARRAY['rear-delts'], '1. For this exercise you will need to place a bench behind your back. With the bench perpendicular to your body, and while looking away from it, hold on to the bench on its edge with the hands fully extended, separated at shoulder width. The legs will be extended forward, bent at the waist and perpendicular to your torso. This will be your starting position.
...
4. Repeat for the recommended amount of repetitions.', NOW(), NOW()),
('ex_bw_035', 'Chest Dip', 'chest dip', ARRAY['chest dips'], 'chest', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dip bars'], ARRAY['chest', 'triceps'], ARRAY['front-delts'], '1. For this exercise you will need access to parallel bars. To get yourself into the starting position, hold your body at arms length (arms locked) above the bars.
...
('ex_bw_036', 'Inverted Row', 'inverted row', ARRAY['bodyweight row', 'australian pullup', 'horizontal pullup'], 'back', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['barbell', 'rack'], ARRAY['lats', 'mid-back'], ARRAY['biceps', 'rear-delts'], '1. Position a bar in a rack to about waist height. You can also use a smith machine.
...
5. Repeat for the desired number of repetitions.', NOW(), NOW()),
...
4. Repeat for the recommended amount of repetitions prescribed in your program.', NOW(), NOW()),
...
3. Extend as far as possible, then reverse the motion to return to the starting position.', NOW(), NOW()),
...
4. Extend as far as possible, pause and then return to the starting position.', NOW(), NOW()),
...
5. After a brief pause, return to the starting position.', NOW(), NOW()),

-- Calisthenics
('ex_bw_041', 'Burpee', 'burpee', ARRAY['burpees'], 'full body', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['bodyweight'], ARRAY['chest', 'quads'], ARRAY['front-delts', 'triceps'], null, NOW(), NOW()),
