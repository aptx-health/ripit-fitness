...
-- Arms (3)
('cmiz7vl1k0009vr0m306fts69', 'Barbell Curl', 'barbell curl', ARRAY[]::text[], 'arms', true, null, '00000000-0000-0000-0000-000000000000', ARRAY[]::text[], ARRAY['biceps'], ARRAY['forearms'], '1. Stand up with your torso upright while holding a barbell at a shoulder-width grip. The palm of your hands should be facing forward and the elbows should be close to the torso. This will be your starting position.
...
('cmiz7vnpc000ovr0mcuhs0bum', 'Hammer Curl', 'hammer curl', ARRAY[]::text[], 'arms', true, null, '00000000-0000-0000-0000-000000000000', ARRAY[]::text[], ARRAY['biceps'], ARRAY['forearms'], '1. Stand up with your torso upright and a dumbbell on each hand being held at arms length. The elbows should be close to the torso.
...
5. Repeat for the recommended amount of repetitions.', NOW(), NOW()),
('cmiz7vl76000avr0m27zo6aos', 'Tricep Pushdown', 'tricep pushdown', ARRAY[]::text[], 'arms', true, null, '00000000-0000-0000-0000-000000000000', ARRAY[]::text[], ARRAY['triceps'], ARRAY[]::text[], '1. Attach a straight or angled bar to a high pulley and grab with an overhand grip (palms facing down) at shoulder width.
...
-- Back (5)
('cmiz7vk1i0003vr0mqucd1f52', 'Barbell Row', 'barbell row', ARRAY[]::text[], 'back', true, null, '00000000-0000-0000-0000-000000000000', ARRAY[]::text[], ARRAY['lats', 'mid-back'], ARRAY['biceps', 'rear-delts'], '1. Holding a barbell with a pronated grip (palms facing down), bend your knees slightly and bring your torso forward, by bending at the waist, while keeping the back straight until it is almost parallel to the floor. Tip: Make sure that you keep the head up. The barbell should hang directly in front of you as your arms hang perpendicular to the floor and your torso. This is your starting position.
...
('cmiz7vmmg000ivr0mojncaj84', 'Cable Row', 'cable row', ARRAY[]::text[], 'back', true, null, '00000000-0000-0000-0000-000000000000', ARRAY[]::text[], ARRAY['lats', 'mid-back'], ARRAY['biceps'], '1. For this exercise you will need access to a low pulley row machine with a V-bar. Note: The V-bar will enable you to have a neutral grip where the palms of your hands face each other. To get into the starting position, first sit down on the machine and place your feet on the front platform or crossbar provided making sure that your knees are slightly bent and not locked.
...
5. Repeat for the recommended amount of repetitions.', NOW(), NOW()),
('cmiz7vjvh0002vr0mtcmhiz70', 'Conventional Deadlift', 'conventional deadlift', ARRAY[]::text[], 'back', true, null, '00000000-0000-0000-0000-000000000000', ARRAY[]::text[], ARRAY['hamstrings', 'glutes', 'lower-back'], ARRAY['traps', 'forearms'], '1. Stand in front of a loaded barbell.
...
5. Perform the amount of repetitions prescribed in the program.', NOW(), NOW()),
('cmiz7vmgd000hvr0mkidkt6uu', 'Dumbbell Row', 'dumbbell row', ARRAY[]::text[], 'back', true, null, '00000000-0000-0000-0000-000000000000', ARRAY[]::text[], ARRAY['lats', 'mid-back'], ARRAY['biceps'], '1. Choose a flat bench and place a dumbbell on each side of it.
...
('cmiz7vkvr0008vr0m7rv3dapc', 'Pull-Up', 'pull-up', ARRAY[]::text[], 'back', true, null, '00000000-0000-0000-0000-000000000000', ARRAY[]::text[], ARRAY['lats', 'biceps'], ARRAY['mid-back', 'forearms'], '1. Grab the pull-up bar with the palms facing forward using the prescribed grip. Note on grips: For a wide grip, your hands need to be spaced out at a distance wider than your shoulder width. For a medium grip, your hands need to be spaced out at a distance equal to your shoulder width and for a close grip at a distance smaller than your shoulder width.
...
5. Repeat this motion for the prescribed amount of repetitions.', NOW(), NOW()),

-- Chest (4)
('cmiz7vjju0000vr0m4b1o6bec', 'Barbell Bench Press', 'barbell bench press', ARRAY[]::text[], 'chest', true, null, '00000000-0000-0000-0000-000000000000', ARRAY[]::text[], ARRAY['chest', 'triceps'], ARRAY['front-delts'], '1. Secure your legs at the end of the decline bench and slowly lay down on the bench.
...
6. When you are done, place the bar back in the rack.', NOW(), NOW()),
('cmiz7vmyl000kvr0mmr9a482v', 'Dips', 'dips', ARRAY[]::text[], 'chest', true, null, '00000000-0000-0000-0000-000000000000', ARRAY[]::text[], ARRAY['chest', 'triceps'], ARRAY['front-delts'], '1. Stand between a set of parallel bars. Place a hand on each bar, and then take a small jump to help you get into the starting position with your arms locked out.
...
4. Repeat for the desired number of repetitions.', NOW(), NOW()),
('cmiz7vkpg0007vr0mpbaneax3', 'Dumbbell Bench Press', 'dumbbell bench press', ARRAY[]::text[], 'chest', true, null, '00000000-0000-0000-0000-000000000000', ARRAY[]::text[], ARRAY['chest', 'triceps'], ARRAY['front-delts'], '1. Lie down on a flat bench with a dumbbell in each hand resting on top of your thighs. The palms of your hands will be facing each other.
...
('cmiz7vkji0006vr0mrxfixnvy', 'Incline Barbell Bench Press', 'incline barbell bench press', ARRAY[]::text[], 'chest', true, null, '00000000-0000-0000-0000-000000000000', ARRAY[]::text[], ARRAY['chest', 'triceps'], ARRAY['front-delts'], '1. Secure your legs at the end of the decline bench and slowly lay down on the bench.
2. Using a medium width grip (a grip that creates a 90-degree angle in the middle of the movement between the forearms and the upper arms), lift the bar from the rack and hold it straight over you with your arms locked. The arms should be perpendicular to the floor. This will be your starting position. Tip: In order to protect your rotator cuff, it is best if you have a spotter help you lift the barbell off the rack.
3. As you breathe in, come down slowly until you feel the bar on your lower chest.
4. After a second pause, bring the bar back to the starting position as you breathe out and push the bar using your chest muscles. Lock your arms and squeeze your chest in the contracted position, hold for a second and then start coming down slowly again. Tip: It should take at least twice as long to go down than to come up).
5. Repeat the movement for the prescribed amount of repetitions.
...
-- Core (1)
('cmiz7vnjj000nvr0mgfa1vmx1', 'Plank', 'plank', ARRAY[]::text[], 'core', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['bodyweight'], ARRAY['abs'], ARRAY[]::text[], '1. Get into a prone position on the floor, supporting your weight on your toes and your forearms. Your arms are bent and directly below the shoulder.
2. Keep your body straight at all times, and hold this position as long as possible. To increase difficulty, an arm or leg can be raised.', NOW(), NOW()),

-- Legs (9)
('cmiz7vjpo0001vr0msv9of7ib', 'Barbell Back Squat', 'barbell back squat', ARRAY[]::text[], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY[]::text[], ARRAY['quads', 'glutes'], ARRAY['hamstrings'], '1. Stand up straight while holding a barbell behind you at arms length and your feet at shoulder width. Tip: A shoulder width grip is best with the palms of your hands facing back. You can use wrist wraps for this exercise for a better grip. This will be your starting position.
...
4. Repeat for the recommended amount of repetitions.', NOW(), NOW()),
('cmiz7vnam000mvr0mano9z27r', 'Calf Raise', 'calf raise', ARRAY[]::text[], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['machine'], ARRAY['calves'], ARRAY[]::text[], '1. Adjust the padded lever of the calf raise machine to fit your height.
...
5. Repeat for the recommended amount of repetitions.', NOW(), NOW()),
('cmiz7vm4s000fvr0mfh2shcrv', 'Front Squat', 'front squat', ARRAY[]::text[], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['barbell', 'rack'], ARRAY['quads'], ARRAY['glutes'], '1. This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack just above shoulder level. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.
...
('cmiz7vljh000cvr0mlk0r5kco', 'Leg Curl', 'leg curl', ARRAY[]::text[], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['machine'], ARRAY['hamstrings'], ARRAY[]::text[], '1. Adjust the machine lever to fit your height and sit on the machine with your back against the back support pad.
...
5. Repeat for the recommended amount of repetitions and ensure to lock the safety pins properly once you are done. You do not want that platform falling on you fully loaded.', NOW(), NOW()),
('cmiz7vn4b000lvr0m5aq17wb7', 'Lunges', 'lunges', ARRAY[]::text[], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY[]::text[], ARRAY['quads', 'glutes'], ARRAY['hamstrings'], '1. Begin standing with your feet shoulder width apart and your hands on your hips.
...
4. Step forward with your rear foot, repeating the lunge on the opposite leg.', NOW(), NOW()),
('cmiz7vkdh0005vr0mr5dm18ls', 'Romanian Deadlift', 'romanian deadlift', ARRAY[]::text[], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY[]::text[], ARRAY['hamstrings', 'glutes'], ARRAY['lower-back'], '1. Put a barbell in front of you on the ground and grab it using a pronated (palms facing down) grip that a little wider than shoulder width. Tip: Depending on the weight used, you may need wrist wraps to perform the exercise and also a raised platform in order to allow for better range of motion.
...
5. Repeat for the recommended amount of repetitions.', NOW(), NOW()),
('cmiz7vma9000gvr0mmjmxhp9s', 'Sumo Deadlift', 'sumo deadlift', ARRAY[]::text[], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY[]::text[], ARRAY['hamstrings', 'glutes', 'adductors'], ARRAY['lower-back', 'traps'], '1. Begin with a bar loaded on the ground. Approach the bar so that the bar intersects the middle of the feet. The feet should be set very wide, near the collars. Bend at the hips to grip the bar. The arms should be directly below the shoulders, inside the legs, and you can use a pronated grip, a mixed grip, or hook grip. Relax the shoulders, which in effect lengthens your arms.
...
4. Return the weight to the ground by bending at the hips and controlling the weight on the way down.', NOW(), NOW()),

-- Shoulders (3)
('cmiz7vmsh000jvr0mq9pwqarc', 'Face Pull', 'face pull', ARRAY[]::text[], 'shoulders', true, null, '00000000-0000-0000-0000-000000000000', ARRAY[]::text[], ARRAY['rear-delts'], ARRAY['traps', 'mid-back'], '1. Facing a high pulley with a rope or dual handles attached, pull the weight directly towards your face, separating your hands as you do so. Keep your upper arms parallel to the ground.', NOW(), NOW()),
('cmiz7vlyh000evr0m9d8snpzh', 'Lateral Raise', 'lateral raise', ARRAY[]::text[], 'shoulders', true, null, '00000000-0000-0000-0000-000000000000', ARRAY[]::text[], ARRAY['side-delts'], ARRAY['traps'], '1. To begin, stand on an exercise band so that tension begins at arm''s length. Grasp the handles using a pronated (palms facing your thighs) grip that is slightly less than shoulder width. The handles should be resting on the sides of your thighs. Your arms should be extended with a slight bend at the elbows and your back should be straight. This will be your starting position.
...
4. Repeat for the recommended amount of repetitions.', NOW(), NOW()),
('cmiz7vk780004vr0md53c57bz', 'Overhead Press', 'overhead press', ARRAY[]::text[], 'shoulders', true, null, '00000000-0000-0000-0000-000000000000', ARRAY[]::text[], ARRAY['front-delts', 'triceps'], ARRAY['chest'], '1. Sit on a bench with back support in a squat rack. Position a barbell at a height that is just above your head. Grab the barbell with a pronated grip (palms facing forward).
