...
('ex_kb_001', 'Kettlebell Swing', 'kettlebell swing', ARRAY['kb swing', 'russian swing', 'two hand swing'], 'full body', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['kettlebell'], ARRAY['glutes', 'hamstrings', 'lower-back'], ARRAY['front-delts', 'abs'], null, null, null, null, NOW(), NOW()),
('ex_kb_002', 'Single Arm Kettlebell Swing', 'single arm kettlebell swing', ARRAY['one arm swing', 'single kb swing'], 'full body', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['kettlebell'], ARRAY['glutes', 'hamstrings', 'lower-back'], ARRAY['front-delts', 'abs', 'obliques'], null, 'pull', 'compound', 'intermediate', NOW(), NOW()),
...
4. As you land, absorb the impact through your legs and draw the dumbbell to your torso before the next repetition.', 'pull', 'compound', 'beginner', NOW(), NOW()),
...
3. Drive through with your hips and lock the ketttlebells overhead in one uninterrupted motion.', 'pull', 'compound', 'expert', NOW(), NOW()),
...
3. Lower the kettlebell, keeping the hamstrings loaded by keeping your back straight and your butt out.', 'pull', 'compound', 'intermediate', NOW(), NOW()),
...
7. Without moving your feet, press the bar overhead as you exhale. Lower the bar under control .', 'push', 'compound', 'intermediate', NOW(), NOW()),
...
2. Begin by extending the hips and knees, simultaneously pulling the kettlebell to your shoulders, raising your elbows as you do so. Reverse the motion to return to the starting position.', 'pull', 'compound', 'intermediate', NOW(), NOW()),
...
3. Once the kettlebells are locked out, lower the kettlebells to your shoulders and repeat.', 'push', 'compound', 'intermediate', NOW(), NOW()),
...
3. Press the bar back up as fast as you can, keeping the bar, your wrists, and elbows in line as you do so.', 'push', 'compound', 'intermediate', NOW(), NOW()),
...
4. As you begin the next repetition, return the weights to the shoulders.', 'push', 'compound', 'intermediate', NOW(), NOW()),
...
3. At the bottom position, pause and use your elbows to push your knees out. Return to the starting position, and repeat for 10-20 repetitions.', 'push', 'compound', 'beginner', NOW(), NOW()),
('ex_kb_013', 'Kettlebell Front Squat', 'kettlebell front squat', ARRAY['kb front squat', 'double kettlebell front squat'], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['kettlebell'], ARRAY['quads', 'glutes'], ARRAY['abs', 'mid-back'], null, null, null, null, NOW(), NOW()),
...
4. Lower yourself again and repeat.', 'push', 'compound', 'expert', NOW(), NOW()),

-- Lunging exercises
('ex_kb_015', 'Kettlebell Lunge', 'kettlebell lunge', ARRAY['kb lunge'], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['kettlebell'], ARRAY['quads', 'glutes'], ARRAY['hamstrings', 'abs'], null, null, null, null, NOW(), NOW()),
...
3. Then lower the kettlebell to the floor and begin the kettlebell in the opposite hand. Repeat for several reps.', 'pull', 'compound', 'expert', NOW(), NOW()),

-- Deadlift variations
('ex_kb_019', 'Kettlebell Deadlift', 'kettlebell deadlift', ARRAY['kb deadlift'], 'back', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['kettlebell'], ARRAY['hamstrings', 'glutes', 'lower-back'], ARRAY['traps', 'forearms'], null, null, null, null, NOW(), NOW()),
('ex_kb_020', 'Single Leg Kettlebell Deadlift', 'single leg kettlebell deadlift', ARRAY['single leg kb deadlift', 'kb single leg rdl'], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['kettlebell'], ARRAY['hamstrings', 'glutes'], ARRAY['lower-back', 'abs'], null, null, null, null, NOW(), NOW()),
...
3. While looking up at the kettlebell, slowly stand up. Reverse the motion back to the starting position and repeat.', 'push', 'compound', 'intermediate', NOW(), NOW()),
...
3. Pause for a second after reaching the ground and reverse the motion back to the starting position.', 'pull', 'compound', 'intermediate', NOW(), NOW()),
('ex_kb_023', 'Kettlebell Halo', 'kettlebell halo', ARRAY['kb halo'], 'shoulders', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['kettlebell'], ARRAY['front-delts', 'side-delts'], ARRAY['abs', 'mid-back'], null, null, null, null, NOW(), NOW()),
...
3. Walk taking short, quick steps, and don''t forget to breathe. Move for a given distance, typically 50-100 feet, as fast as possible.', null, 'compound', 'intermediate', NOW(), NOW()),
('ex_kb_026', 'Kettlebell Rack Carry', 'kettlebell rack carry', ARRAY['kb rack carry', 'rack walk'], 'full body', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['kettlebell'], ARRAY['abs', 'front-delts'], ARRAY['calves', 'mid-back'], null, null, null, null, NOW(), NOW()),
('ex_kb_027', 'Kettlebell Overhead Carry', 'kettlebell overhead carry', ARRAY['kb overhead carry', 'overhead walk'], 'full body', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['kettlebell'], ARRAY['front-delts', 'abs'], ARRAY['triceps', 'calves'], null, null, null, null, NOW(), NOW())
