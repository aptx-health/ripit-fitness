...
('ex_mo_001', 'Ab Wheel Rollout', 'ab wheel rollout', ARRAY['ab roller', 'ab wheel', 'wheel rollout'], 'core', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['ab wheel'], ARRAY['abs'], ARRAY['front-delts', 'lower-back'], '1. Hold the Ab Roller with both hands and kneel on the floor.
...
4. After a pause at the stretched position, start pulling yourself back to the starting position as you breathe out. Tip: Go slowly and keep your abs tight at all times.', NOW(), NOW()),
...
7. Repeat on the opposite side, alternating until the set is complete.', NOW(), NOW()),
('ex_mo_003', 'Bird Dog', 'bird dog', ARRAY['birddog', 'bird dog exercise'], 'core', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['bodyweight'], ARRAY['abs', 'lower-back'], ARRAY['glutes', 'front-delts'], null, NOW(), NOW()),
('ex_mo_004', 'Dragon Flag', 'dragon flag', ARRAY['dragon flags'], 'core', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['bench'], ARRAY['abs'], ARRAY['lats'], null, NOW(), NOW()),
('ex_mo_005', 'L-Sit', 'l-sit', ARRAY['l sit', 'lsit'], 'core', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['parallel bars'], ARRAY['abs'], ARRAY['triceps', 'front-delts'], null, NOW(), NOW()),
('ex_mo_006', 'Copenhagen Plank', 'copenhagen plank', ARRAY['copenhagen side plank', 'adductor plank'], 'core', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['bench'], ARRAY['adductors', 'obliques'], ARRAY['abs'], null, NOW(), NOW()),
('ex_mo_007', 'Pallof Press', 'pallof press', ARRAY['band pallof press', 'anti rotation press'], 'core', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['resistance band'], ARRAY['abs', 'obliques'], ARRAY['front-delts'], '1. Connect a standard handle to a tower, and—if possible—position the cable to shoulder height. If not, a low pulley will suffice.
...
2. Shift your weight forward until you feel a stretch in your hip. Hold for 15 seconds, then repeat for your other side.', NOW(), NOW()),
...
4. Return to upright position and then repeat for your other side.', NOW(), NOW()),
...
3. Once you settle onto your heels, bring your hands next to your feet and relax. "breathe" into your back. Rest your forehead on the floor. Avoid this position if you have knee problems.', NOW(), NOW()),
...
2. While resting on your stomach on the ball, walk your hands forward along the floor and lift your legs, extending your elbows and knees.', NOW(), NOW()),
('ex_mo_013', 'Cobra Stretch', 'cobra stretch', ARRAY['cobra pose', 'sphinx pose'], 'mobility', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['bodyweight'], ARRAY['abs'], ARRAY['chest'], null, NOW(), NOW()),
...
3. Twist your upper body to one side about 3 times as far as you can. Then lean forward and twist your torso to reach your elbow to the floor on the inside of your knee.
4. Return to upright position and then repeat for your other side.', NOW(), NOW()),
('ex_mo_015', '90/90 Hip Stretch', 'ninety ninety hip stretch', ARRAY['90-90 stretch', '90/90 stretch', 'seated hip stretch'], 'mobility', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['bodyweight'], ARRAY['glutes'], ARRAY[]::text[], null, NOW(), NOW()),

-- Dynamic mobility exercises
('ex_mo_016', 'Leg Swing', 'leg swing', ARRAY['leg swings', 'dynamic leg swing'], 'mobility', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['bodyweight'], ARRAY['hamstrings'], ARRAY[]::text[], null, NOW(), NOW()),
...
3. Continue the circular motion of the outstretched arms for about ten seconds. Then reverse the movement, going the opposite direction.', NOW(), NOW()),
...
3. After 10-20 seconds, place your hands on either side of your front foot. Raise the toes of the front foot off of the ground, and straighten your leg. You may need to reposition your rear leg to do so. Hold for 10-20 seconds, and then repeat the entire sequence for the other side.', NOW(), NOW()),
...
5. Continue walking until your feet are by hour hands, keeping your legs straight as you do so.', NOW(), NOW()),
('ex_mo_020', 'Scorpion Stretch', 'scorpion stretch', ARRAY['scorpion'], 'mobility', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['bodyweight'], ARRAY['mid-back'], ARRAY['glutes', 'obliques'], null, NOW(), NOW()),

-- Foam rolling and recovery
('ex_mo_021', 'Foam Roll IT Band', 'foam roll it band', ARRAY['it band foam roll', 'itb foam roll'], 'mobility', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['foam roller'], ARRAY['quads'], ARRAY[]::text[], null, NOW(), NOW()),
('ex_mo_022', 'Foam Roll Quads', 'foam roll quads', ARRAY['quad foam roll', 'quadriceps foam roll'], 'mobility', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['foam roller'], ARRAY['quads'], ARRAY[]::text[], '1. Lay facedown on the floor with your weight supported by your hands or forearms. Place a foam roll underneath one leg on the quadriceps, and keep the foot off of the ground. Make sure to relax the leg as much as possible. This will be your starting position.
2. Shifting as much weight onto the leg to be stretched as is tolerable, roll over the foam from above the knee to below the hip, holding points of tension for 10-30 seconds. Switch sides.', NOW(), NOW()),
('ex_mo_023', 'Foam Roll Upper Back', 'foam roll upper back', ARRAY['thoracic spine foam roll', 'upper back foam roll'], 'mobility', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['foam roller'], ARRAY['mid-back'], ARRAY[]::text[], '1. While seated, bend forward to hug your thighs from underneath with both arms.
2. Keep your knees together and your legs extended out as you bring your chest down to your knees. You can also stretch your middle back by pulling your back away from your knees as your hugging them.', NOW(), NOW()),
('ex_mo_024', 'Lacrosse Ball Glute Release', 'lacrosse ball glute release', ARRAY['glute smash', 'lacrosse ball glutes'], 'mobility', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['lacrosse ball'], ARRAY['glutes'], ARRAY[]::text[], null, NOW(), NOW())
