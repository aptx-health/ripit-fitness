...
-- Chest exercises
('ex_db_001', 'Incline Dumbbell Bench Press', 'incline dumbbell bench press', ARRAY['incline db bench', 'incline dumbbell press'], 'chest', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells', 'incline bench'], ARRAY['chest', 'triceps'], ARRAY['front-delts'], '1. Lie back on an incline bench with a dumbbell in each hand atop your thighs. The palms of your hands will be facing each other.
...
7. When you are done, place the dumbbells back on your thighs and then on the floor. This is the safest manner to release the dumbbells.', NOW(), NOW()),
('ex_db_002', 'Decline Dumbbell Bench Press', 'decline dumbbell bench press', ARRAY['decline db bench', 'decline dumbbell press'], 'chest', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells', 'decline bench'], ARRAY['chest', 'triceps'], ARRAY['front-delts'], '1. Secure your legs at the end of the decline bench and lie down with a dumbbell on each hand on top of your thighs. The palms of your hand will be facing each other.
...
6. Repeat the movement for the prescribed amount of repetitions of your training program.', NOW(), NOW()),
('ex_db_003', 'Dumbbell Fly', 'dumbbell fly', ARRAY['db fly', 'dumbbell flys', 'chest fly'], 'chest', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells', 'bench'], ARRAY['chest'], ARRAY['front-delts'], '1. Lie down on a flat bench with a dumbbell on each hand resting on top of your thighs. The palms of your hand will be facing each other.
...
5. Hold for a second at the contracted position and repeat the movement for the prescribed amount of repetitions.', NOW(), NOW()),
('ex_db_004', 'Incline Dumbbell Fly', 'incline dumbbell fly', ARRAY['incline db fly', 'incline chest fly'], 'chest', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells', 'incline bench'], ARRAY['chest'], ARRAY['front-delts'], '1. Hold a dumbbell on each hand and lie on an incline bench that is set to an incline angle of no more than 30 degrees.
...
('ex_db_005', 'Dumbbell Pullover', 'dumbbell pullover', ARRAY['db pullover', 'pullover'], 'chest', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells', 'bench'], ARRAY['chest', 'lats'], ARRAY['triceps'], '1. Lie down on a flat bench with a dumbbell on each hand resting on top of your thighs. The palms of your hand will be facing each other.
2. Then using your thighs to help raise the dumbbells, lift the dumbbells one at a time so you can hold them in front of you at shoulder width with the palms of your hands facing each other. Raise the dumbbells up like you''re pressing them, but stop and hold just before you lock out. This will be your starting position.
3. With a slight bend on your elbows in order to prevent stress at the biceps tendon, lower your arms out at both sides in a wide arc until you feel a stretch on your chest. Breathe in as you perform this portion of the movement. Tip: Keep in mind that throughout the movement, the arms should remain stationary; the movement should only occur at the shoulder joint.
4. Return your arms back to the starting position as you squeeze your chest muscles and breathe out. Tip: Make sure to use the same arc of motion used to lower the weights.
5. Hold for a second at the contracted position and repeat the movement for the prescribed amount of repetitions.', NOW(), NOW()),
...
-- Shoulder exercises
('ex_db_006', 'Dumbbell Shoulder Press', 'dumbbell shoulder press', ARRAY['db shoulder press', 'seated db press', 'dumbbell press'], 'shoulders', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells', 'bench'], ARRAY['front-delts', 'triceps'], ARRAY['side-delts'], '1. While holding a dumbbell in each hand, sit on a military press bench or utility bench that has back support. Place the dumbbells upright on top of your thighs.
...
6. Repeat for the recommended amount of repetitions.', NOW(), NOW()),
('ex_db_007', 'Arnold Press', 'arnold press', ARRAY['arnold shoulder press', 'arnold dumbbell press'], 'shoulders', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells', 'bench'], ARRAY['front-delts', 'side-delts', 'triceps'], ARRAY['chest'], '1. Sit on an exercise bench with back support and hold two dumbbells in front of you at about upper chest level with your palms facing your body and your elbows bent. Tip: Your arms should be next to your torso. The starting position should look like the contracted portion of a dumbbell curl.
...
('ex_db_008', 'Front Raise', 'front raise', ARRAY['dumbbell front raise', 'db front raise'], 'shoulders', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['front-delts'], ARRAY['chest'], '1. Pick a couple of dumbbells and stand with a straight torso and the dumbbells on front of your thighs at arms length with the palms of the hand facing your thighs. This will be your starting position.
...
4. Continue alternating in this fashion until all of the recommended amount of repetitions have been performed for each arm.', NOW(), NOW()),
('ex_db_009', 'Rear Delt Fly', 'rear delt fly', ARRAY['reverse fly', 'bent over fly', 'rear delt raise'], 'shoulders', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['rear-delts'], ARRAY['mid-back', 'traps'], '1. While holding a dumbbell in each hand, lay with your chest down on a flat bench.
...
5. Repeat for the recommended amount of repetitions and then switch to the other arm.', NOW(), NOW()),
('ex_db_010', 'Upright Row', 'upright row', ARRAY['dumbbell upright row', 'db upright row'], 'shoulders', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['side-delts', 'traps'], ARRAY['biceps'], '1. Grasp a dumbbell in each hand with a pronated (palms forward) grip that is slightly less than shoulder width. The dumbbells should be resting on top of your thighs. Your arms should be extended with a slight bend at the elbows and your back should be straight. This will be your starting position.
...
-- Back exercises
('ex_db_011', 'Single Arm Dumbbell Row', 'single arm dumbbell row', ARRAY['one arm db row', 'single arm row', 'one arm dumbbell row'], 'back', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells', 'bench'], ARRAY['lats', 'mid-back'], ARRAY['biceps', 'rear-delts'], '1. Choose a flat bench and place a dumbbell on each side of it.
...
7. Switch sides and repeat again with the other arm.', NOW(), NOW()),
('ex_db_012', 'Bent Over Dumbbell Row', 'bent over dumbbell row', ARRAY['bent over db row', 'two arm dumbbell row'], 'back', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['lats', 'mid-back'], ARRAY['biceps', 'rear-delts'], '1. With a dumbbell in each hand (palms facing your torso), bend your knees slightly and bring your torso forward by bending at the waist; as you bend make sure to keep your back straight until it is almost parallel to the floor. Tip: Make sure that you keep the head up. The weights should hang directly in front of you as your arms hang perpendicular to the floor and your torso. This is your starting position.
...
4. Repeat for the recommended amount of repetitions.', NOW(), NOW()),
('ex_db_013', 'Dumbbell Deadlift', 'dumbbell deadlift', ARRAY['db deadlift', 'dumbbell dl'], 'back', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['hamstrings', 'glutes', 'lower-back'], ARRAY['traps', 'forearms'], '1. Lie down on a flat bench with a dumbbell on each hand resting on top of your thighs. The palms of your hand will be facing each other.
2. Then using your thighs to help raise the dumbbells, lift the dumbbells one at a time so you can hold them in front of you at shoulder width with the palms of your hands facing each other. Raise the dumbbells up like you''re pressing them, but stop and hold just before you lock out. This will be your starting position.
3. With a slight bend on your elbows in order to prevent stress at the biceps tendon, lower your arms out at both sides in a wide arc until you feel a stretch on your chest. Breathe in as you perform this portion of the movement. Tip: Keep in mind that throughout the movement, the arms should remain stationary; the movement should only occur at the shoulder joint.
4. Return your arms back to the starting position as you squeeze your chest muscles and breathe out. Tip: Make sure to use the same arc of motion used to lower the weights.
5. Hold for a second at the contracted position and repeat the movement for the prescribed amount of repetitions.', NOW(), NOW()),
('ex_db_014', 'Dumbbell Romanian Deadlift', 'dumbbell romanian deadlift', ARRAY['db rdl', 'dumbbell rdl'], 'back', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['hamstrings', 'glutes'], ARRAY['lower-back', 'forearms'], '1. Put a barbell in front of you on the ground and grab it using a pronated (palms facing down) grip that a little wider than shoulder width. Tip: Depending on the weight used, you may need wrist wraps to perform the exercise and also a raised platform in order to allow for better range of motion.
...
5. Repeat for the recommended amount of repetitions.', NOW(), NOW()),
('ex_db_015', 'Dumbbell Shrug', 'dumbbell shrug', ARRAY['db shrug', 'dumbbell shrugs'], 'back', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['traps'], ARRAY['forearms'], '1. Stand erect with a dumbbell on each hand (palms facing your torso), arms extended on the sides.
...
('ex_db_016', 'Dumbbell Curl', 'dumbbell curl', ARRAY['db curl', 'dumbbell curls', 'bicep curl'], 'arms', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['biceps'], ARRAY['forearms'], '1. Stand up straight with a dumbbell in each hand at arm''s length. Keep your elbows close to your torso and rotate the palms of your hands until they are facing forward. This will be your starting position.
...
4. Repeat for the recommended amount of repetitions.', NOW(), NOW()),
('ex_db_017', 'Alternating Dumbbell Curl', 'alternating dumbbell curl', ARRAY['alternating db curl', 'alternate dumbbell curl'], 'arms', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['biceps'], ARRAY['forearms'], '1. Sit down on an incline bench with a dumbbell in each hand being held at arms length. Tip: Keep the elbows close to the torso.This will be your starting position.
...
5. Continue alternating in this manner for the recommended amount of repetitions.', NOW(), NOW()),
('ex_db_018', 'Incline Dumbbell Curl', 'incline dumbbell curl', ARRAY['incline db curl', 'incline bicep curl'], 'arms', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells', 'incline bench'], ARRAY['biceps'], ARRAY['forearms'], '1. Sit back on an incline bench with a dumbbell in each hand held at arms length. Keep your elbows close to your torso and rotate the palms of your hands until they are facing forward. This will be your starting position.
...
4. Repeat for the recommended amount of repetitions.', NOW(), NOW()),
('ex_db_019', 'Concentration Curl', 'concentration curl', ARRAY['seated concentration curl', 'dumbbell concentration curl'], 'arms', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells', 'bench'], ARRAY['biceps'], ARRAY['forearms'], '1. Sit down on a flat bench with one dumbbell in front of you between your legs. Your legs should be spread with your knees bent and feet on the floor.
...
5. Repeat for the recommended amount of repetitions. Then repeat the movement with the left arm.', NOW(), NOW()),
('ex_db_020', 'Preacher Curl', 'preacher curl', ARRAY['dumbbell preacher curl', 'db preacher curl'], 'arms', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells', 'preacher bench'], ARRAY['biceps'], ARRAY['forearms'], '1. To perform this movement you will need a preacher bench and an E-Z bar. Grab the E-Z curl bar at the close inner handle (either have someone hand you the bar which is preferable or grab the bar from the front bar rest provided by most preacher benches). The palm of your hands should be facing forward and they should be slightly tilted inwards due to the shape of the bar.
...
5. Repeat for the recommended amount of repetitions.', NOW(), NOW()),
('ex_db_021', 'Spider Curl', 'spider curl', ARRAY['spider curls', 'incline spider curl'], 'arms', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells', 'incline bench'], ARRAY['biceps'], ARRAY['forearms'], '1. Start out by setting the bar on the part of the preacher bench that you would normally sit on. Make sure to align the barbell properly so that it is balanced and will not fall off.
...
7. Repeat for the recommended amount of repetitions.', NOW(), NOW()),
('ex_db_022', 'Zottman Curl', 'zottman curl', ARRAY['zottman curls'], 'arms', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['biceps', 'forearms'], ARRAY[]::text[], '1. Stand up with your torso upright and a dumbbell in each hand being held at arms length. The elbows should be close to the torso.
...
8. Repeat for the recommended amount of repetitions.', NOW(), NOW()),

-- Arm exercises - Triceps
('ex_db_023', 'Dumbbell Overhead Tricep Extension', 'dumbbell overhead tricep extension', ARRAY['overhead db extension', 'dumbbell tricep extension', 'two arm overhead extension'], 'arms', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['triceps'], ARRAY[]::text[], '1. Lie on a flat bench while holding two dumbbells directly in front of you. Your arms should be fully extended at a 90-degree angle from your torso and the floor. The palms should be facing in and the elbows should be tucked in. This is the starting position.
...
4. Repeat for the recommended amount of repetitions.', NOW(), NOW()),
('ex_db_024', 'Single Arm Overhead Tricep Extension', 'single arm overhead tricep extension', ARRAY['one arm overhead extension', 'single arm db extension'], 'arms', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['triceps'], ARRAY[]::text[], '1. Attach dual handles to a sled using a chain or rope. Load the sled to an appropriate load.
...
4. Upon full extension, step forward to take the slack out of the line. You may keep your feet staggered for more stability.', NOW(), NOW()),
('ex_db_025', 'Dumbbell Tricep Kickback', 'dumbbell tricep kickback', ARRAY['tricep kickback', 'db kickback'], 'arms', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['triceps'], ARRAY[]::text[], '1. Start with a dumbbell in each hand and your palms facing your torso. Keep your back straight with a slight bend in the knees and bend forward at the waist. Your torso should be almost parallel to the floor. Make sure to keep your head up. Your upper arms should be close to your torso and parallel to the floor. Your forearms should be pointed towards the floor as you hold the weights. There should be a 90-degree angle formed between your forearm and upper arm. This is your starting position.
...
4. Repeat the movement for the prescribed amount of repetitions.', NOW(), NOW()),
('ex_db_026', 'Tate Press', 'tate press', ARRAY['tate db press'], 'arms', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells', 'bench'], ARRAY['triceps'], ARRAY['chest'], '1. Lie down on a flat bench with a dumbbell in each hand on top of your thighs. The palms of your hand will be facing each other.
...
5. Repeat the movement for the prescribed amount of repetitions of your training program.', NOW(), NOW()),
('ex_db_027', 'Dumbbell Skull Crusher', 'dumbbell skull crusher', ARRAY['db skull crusher', 'lying tricep extension'], 'arms', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells', 'bench'], ARRAY['triceps'], ARRAY[]::text[], '1. Lie on a flat bench and grasp the straight bar attachment of a low pulley with a narrow overhand grip. Tip: The easiest way to do this is to have someone hand you the bar as you lay down.
...
5. Hold for a second at the contracted position and repeat for the recommended amount of repetitions.', NOW(), NOW()),

-- Leg exercises
('ex_db_028', 'Dumbbell Goblet Squat', 'dumbbell goblet squat', ARRAY['goblet squat', 'db goblet squat'], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['quads', 'glutes'], ARRAY['abs'], '1. Stand holding a light kettlebell by the horns close to your chest. This will be your starting position.
...
('ex_db_029', 'Dumbbell Front Squat', 'dumbbell front squat', ARRAY['db front squat'], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['quads', 'glutes'], ARRAY['abs'], null, NOW(), NOW()),
('ex_db_030', 'Dumbbell Sumo Squat', 'dumbbell sumo squat', ARRAY['db sumo squat', 'sumo goblet squat'], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['quads', 'glutes', 'adductors'], ARRAY['hamstrings'], null, NOW(), NOW()),
('ex_db_031', 'Dumbbell Bulgarian Split Squat', 'dumbbell bulgarian split squat', ARRAY['db bulgarian split squat'], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells', 'bench'], ARRAY['quads', 'glutes'], ARRAY['hamstrings', 'abs'], '1. Stand up straight while holding a barbell placed on the back of your shoulders (slightly below the neck). Your feet should be placed wide apart with the foot of the lead leg angled out to the side. This will be your starting position.
...
4. After performing the recommended amount of reps, repeat the movement with the opposite leg.', NOW(), NOW()),
('ex_db_032', 'Dumbbell Lunge', 'dumbbell lunge', ARRAY['db lunge', 'dumbbell forward lunge'], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['quads', 'glutes'], ARRAY['hamstrings', 'abs'], '1. Stand with your torso upright holding two dumbbells in your hands by your sides. This will be your starting position.
...
4. Repeat the movement for the recommended amount of repetitions and then perform with the left leg.', NOW(), NOW()),
('ex_db_033', 'Dumbbell Reverse Lunge', 'dumbbell reverse lunge', ARRAY['db reverse lunge'], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['quads', 'glutes'], ARRAY['hamstrings', 'abs'], '1. Stand with your torso upright holding two dumbbells in your hands by your sides. This will be your starting position.
...
4. Now repeat with the opposite leg.', NOW(), NOW()),
('ex_db_034', 'Dumbbell Walking Lunge', 'dumbbell walking lunge', ARRAY['db walking lunge'], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['quads', 'glutes'], ARRAY['hamstrings', 'abs'], null, NOW(), NOW()),
('ex_db_035', 'Dumbbell Step-Up', 'dumbbell step-up', ARRAY['db step up', 'dumbbell step up'], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells', 'bench'], ARRAY['quads', 'glutes'], ARRAY['hamstrings'], '1. Stand up straight while holding a dumbbell on each hand (palms facing the side of your legs).
...
4. Repeat with the right leg for the recommended amount of repetitions and then perform with the left leg.', NOW(), NOW()),
('ex_db_036', 'Dumbbell Calf Raise', 'dumbbell calf raise', ARRAY['db calf raise', 'dumbbell calf raises'], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['calves'], ARRAY[]::text[], '1. Stand with your torso upright holding two dumbbells in your hands by your sides. Place the ball of the foot on a sturdy and stable wooden board (that is around 2-3 inches tall) while your heels extend off and touch the floor. This will be your starting position.
...
4. Repeat for the recommended amount of times.', NOW(), NOW()),

-- Glute exercises
('ex_db_037', 'Dumbbell Hip Thrust', 'dumbbell hip thrust', ARRAY['db hip thrust'], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells', 'bench'], ARRAY['glutes', 'hamstrings'], ARRAY['lower-back'], null, NOW(), NOW()),
('ex_db_038', 'Dumbbell Single Leg Deadlift', 'dumbbell single leg deadlift', ARRAY['db single leg deadlift', 'single leg rdl'], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['hamstrings', 'glutes'], ARRAY['lower-back', 'abs'], null, NOW(), NOW()),
('ex_db_039', 'Dumbbell Stiff Leg Deadlift', 'dumbbell stiff leg deadlift', ARRAY['db stiff leg deadlift', 'dumbbell sldl'], 'legs', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['hamstrings', 'glutes'], ARRAY['lower-back'], '1. Lie down on a flat bench with a dumbbell on each hand resting on top of your thighs. The palms of your hand will be facing each other.
2. Then using your thighs to help raise the dumbbells, lift the dumbbells one at a time so you can hold them in front of you at shoulder width with the palms of your hands facing each other. Raise the dumbbells up like you''re pressing them, but stop and hold just before you lock out. This will be your starting position.
3. With a slight bend on your elbows in order to prevent stress at the biceps tendon, lower your arms out at both sides in a wide arc until you feel a stretch on your chest. Breathe in as you perform this portion of the movement. Tip: Keep in mind that throughout the movement, the arms should remain stationary; the movement should only occur at the shoulder joint.
4. Return your arms back to the starting position as you squeeze your chest muscles and breathe out. Tip: Make sure to use the same arc of motion used to lower the weights.
5. Hold for a second at the contracted position and repeat the movement for the prescribed amount of repetitions.', NOW(), NOW()),
...
4. Repeat for the recommended amount of repetitions and then change hands.', NOW(), NOW()),
('ex_db_041', 'Dumbbell Russian Twist', 'dumbbell russian twist', ARRAY['db russian twist', 'weighted russian twist'], 'core', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['obliques', 'abs'], ARRAY[]::text[], '1. Lie down on the floor placing your feet either under something that will not move or by having a partner hold them. Your legs should be bent at the knees.
...
5. Repeat for the recommended amount of repetitions.', NOW(), NOW()),
('ex_db_042', 'Dumbbell Woodchop', 'dumbbell woodchop', ARRAY['db woodchop', 'wood chop'], 'core', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['obliques'], ARRAY['front-delts'], null, NOW(), NOW()),

-- Forearm exercises
('ex_db_043', 'Dumbbell Wrist Curl', 'dumbbell wrist curl', ARRAY['db wrist curl', 'wrist curls'], 'arms', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['forearms'], ARRAY[]::text[], '1. Start out by placing a flat bench in front of a low pulley cable that has a straight bar attachment.
...
6. Repeat for the recommended amount of repetitions.', NOW(), NOW()),
('ex_db_044', 'Dumbbell Reverse Wrist Curl', 'dumbbell reverse wrist curl', ARRAY['db reverse wrist curl', 'reverse wrist curls'], 'arms', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['forearms'], ARRAY[]::text[], '1. Stand up with your torso upright while holding a bar attachment that is attached to a low pulley using a pronated (palms down) and shoulder width grip. Make sure also that you keep the elbows close to the torso. This will be your starting position.
...
4. Repeat for the recommended amount of repetitions.', NOW(), NOW()),
('ex_db_045', 'Farmer Walk', 'farmer walk', ARRAY['farmers walk', 'farmer carry', 'farmers carry'], 'full body', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['forearms', 'traps'], ARRAY['abs', 'calves'], '1. There are various implements that can be used for the farmers walk. These can also be performed with heavy dumbbells or short bars if these implements aren''t available. Begin by standing between the implements.
...
-- Full body
('ex_db_046', 'Dumbbell Thruster', 'dumbbell thruster', ARRAY['db thruster', 'dumbbell squat press'], 'full body', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['quads', 'front-delts'], ARRAY['glutes', 'triceps', 'abs'], '1. Stand up straight while holding a dumbbell on each hand (palms facing the side of your legs).
...
5. Repeat for the recommended amount of repetitions.', NOW(), NOW()),
('ex_db_047', 'Dumbbell Snatch', 'dumbbell snatch', ARRAY['db snatch', 'single arm snatch'], 'full body', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['front-delts', 'glutes', 'hamstrings'], ARRAY['traps', 'abs', 'triceps'], null, NOW(), NOW()),
('ex_db_048', 'Dumbbell Clean', 'dumbbell clean', ARRAY['db clean', 'dumbbell hang clean'], 'full body', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['hamstrings', 'glutes', 'front-delts'], ARRAY['traps', 'abs'], '1. Begin standing with a dumbbell in each hand with your feet shoulder width apart.
...
5. Upon receiving the weight in the squat position, extend the hips and knees to finish in a standing position with the weights on your shoulders.', NOW(), NOW()),
('ex_db_049', 'Dumbbell Clean and Press', 'dumbbell clean and press', ARRAY['db clean and press'], 'full body', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['front-delts', 'hamstrings', 'glutes'], ARRAY['traps', 'triceps', 'abs'], '1. Assume a shoulder-width stance, with knees inside the arms. Now while keeping the back flat, bend at the knees and hips so that you can grab the bar with the arms fully extended and a pronated grip that is slightly wider than shoulder width. Point the elbows out to sides. The bar should be close to the shins. Position the shoulders over or slightly ahead of the bar. Establish a flat back posture. This will be your starting position.
...
('ex_db_050', 'Man Maker', 'man maker', ARRAY['manmaker', 'dumbbell man maker'], 'full body', true, null, '00000000-0000-0000-0000-000000000000', ARRAY['dumbbells'], ARRAY['chest', 'front-delts', 'quads', 'lats'], ARRAY['triceps', 'abs'], null, NOW(), NOW())
